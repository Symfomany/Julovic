...
// Start of date v.5.3.6-13ubuntu3.2
 ...
 * <i>timestamp</i>, false is returned and an
 ...
 * The number of the minute relevant to the start of the <i>hour</i>.
 * Negative values reference the minute in the previous hour.
 * Values greater than 59 reference the appropriate minute in the following hour(s).
 * </p>
 * @param int $second [optional] <p>
 * The number of seconds relevant to the start of the <i>minute</i>.
 ...
 * <i>timezone_identifier</i> isn't valid, or true
 * otherwise.
 */
...
// End of date v.5.3.6-13ubuntu3.2
?>
