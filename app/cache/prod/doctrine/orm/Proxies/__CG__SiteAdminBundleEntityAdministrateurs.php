...
class Administrateurs extends \Site\AdminBundle\Entity\Administrateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'firstname', 'lastname', 'picture', 'description', 'email', 'password', 'optin', 'ip', 'salt', 'token', 'updatedAt', 'createdAt', 'dateAuth', 'enabled', 'dob', 'tel', 'adresse', 'ville', 'zipcode', 'accountNonLocked', 'accountNonExpired', 'slug', 'medias');
    }
